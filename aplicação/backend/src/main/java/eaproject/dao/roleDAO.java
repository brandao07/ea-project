...
public class roleDAO {
	...
	public static boolean save(eaproject.dao.role lrole) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().saveObject(lrole);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.role lrole) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().deleteObject(lrole);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.role lrole) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().refresh(lrole);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.role lrole) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().evict(lrole);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
