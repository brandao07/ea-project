...
public class Location implements Serializable {
    ...
    public final TrialSetCollection trial = new TrialSetCollection(this, _ormAdapter, ORMConstants.KEY_LOCATION_TRIAL, ORMConstants.KEY_TRIAL_LOCATION, ORMConstants.KEY_MUL_ONE_TO_MANY);
