...
public class grade implements Serializable {
	...
	private java.util.Set this_getSet (int key) {
		if (key == ORMConstants.KEY_GRADE_TRIAL) {
			return ORM_trial;
		}
	...
	public final eaproject.dao.trialSetCollection trial = new eaproject.dao.trialSetCollection(this, _ormAdapter, ORMConstants.KEY_GRADE_TRIAL, ORMConstants.KEY_TRIAL_GRADE, ORMConstants.KEY_MUL_ONE_TO_MANY);
