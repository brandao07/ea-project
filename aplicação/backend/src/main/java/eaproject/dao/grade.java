...
public class Grade implements Serializable {
    ...
    public final TrialSetCollection trial = new TrialSetCollection(this, _ormAdapter, ORMConstants.KEY_GRADE_TRIAL, ORMConstants.KEY_TRIAL_GRADE, ORMConstants.KEY_MUL_ONE_TO_MANY);
