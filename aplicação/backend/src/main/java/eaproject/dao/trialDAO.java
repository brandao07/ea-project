...
public class trialDAO {
	...
	public static boolean save(eaproject.dao.trial ltrial) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().saveObject(ltrial);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.trial ltrial) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().deleteObject(ltrial);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.trial ltrial) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().refresh(ltrial);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.trial ltrial) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().evict(ltrial);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
