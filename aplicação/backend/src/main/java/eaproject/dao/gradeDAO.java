...
public class gradeDAO {
	...
	public static boolean save(eaproject.dao.grade lgrade) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().saveObject(lgrade);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.grade lgrade) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().deleteObject(lgrade);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.grade lgrade) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().refresh(lgrade);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.grade lgrade) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().evict(lgrade);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
