...
public class role implements Serializable {
	...
	public final eaproject.dao.userSetCollection user = new eaproject.dao.userSetCollection(this, _ormAdapter, ORMConstants.KEY_ROLE_USER, ORMConstants.KEY_USER_ROLE, ORMConstants.KEY_MUL_ONE_TO_MANY);
