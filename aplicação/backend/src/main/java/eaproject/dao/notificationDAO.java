...
public class notificationDAO {
	...
	public static boolean save(eaproject.dao.notification lnotification) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().saveObject(lnotification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.notification lnotification) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().deleteObject(lnotification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.notification lnotification) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().refresh(lnotification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.notification lnotification) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().evict(lnotification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
