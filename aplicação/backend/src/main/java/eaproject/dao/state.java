...
public class State implements Serializable {
    ...
    public final TrialSetCollection trial = new TrialSetCollection(this, _ormAdapter, ORMConstants.KEY_STATE_TRIAL, ORMConstants.KEY_TRIAL_STATE, ORMConstants.KEY_MUL_ONE_TO_MANY);
