...
public class competitionDAO {
	...
	public static boolean save(eaproject.dao.competition lcompetition) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().saveObject(lcompetition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.competition lcompetition) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().deleteObject(lcompetition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.competition lcompetition) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().refresh(lcompetition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.competition lcompetition) throws PersistentException {
		try {
			AASICProjectPersistentManager.instance().getSession().evict(lcompetition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
