...
public class TrialDAO {
	...
	public static boolean save(dao.Trial trial) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Trial trial) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Trial trial)throws PersistentException {
		try {
			...
			dao.Result[] lResults = trial.result.toArray();
	...
	public static boolean deleteAndDissociate(dao.Trial trial, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (trial.getState() != null) {
				trial.getState().trial.remove(trial);
			}
	...
	public static boolean refresh(dao.Trial trial) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Trial trial) throws PersistentException {
		try {
