...
public class TeamDAO {
	...
	public static boolean save(dao.Team team) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Team team) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Team team)throws PersistentException {
		try {
			if (team.getClub() != null) {
				team.getClub().team.remove(team);
			}
			
			dao.User[] lUsers = team.user.toArray();
	...
	public static boolean deleteAndDissociate(dao.Team team, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (team.getClub() != null) {
				team.getClub().team.remove(team);
			}
	...
	public static boolean refresh(dao.Team team) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Team team) throws PersistentException {
		try {
