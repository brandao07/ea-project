...
public class ClubDAO {
	...
	public static boolean save(dao.Club club) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Club club) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Club club)throws PersistentException {
		try {
			dao.Team[] lTeams = club.team.toArray();
	...
	public static boolean deleteAndDissociate(dao.Club club, org.orm.PersistentSession session)throws PersistentException {
		try {
			dao.Team[] lTeams = club.team.toArray();
			for(int i = 0; i < lTeams.length; i++) {
				lTeams[i].setClub(null);
	...
	public static boolean refresh(dao.Club club) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Club club) throws PersistentException {
		try {
