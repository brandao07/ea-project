...
public class StateDAO {
	...
	public static boolean save(dao.State state) throws PersistentException {
		try {
	...
	public static boolean delete(dao.State state) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.State state)throws PersistentException {
		try {
			dao.Trial[] lTrials = state.trial.toArray();
	...
	public static boolean deleteAndDissociate(dao.State state, org.orm.PersistentSession session)throws PersistentException {
		try {
			dao.Trial[] lTrials = state.trial.toArray();
			for(int i = 0; i < lTrials.length; i++) {
				lTrials[i].setState(null);
	...
	public static boolean refresh(dao.State state) throws PersistentException {
		try {
	...
	public static boolean evict(dao.State state) throws PersistentException {
		try {
