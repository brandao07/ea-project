...
public class UserDAO {
	...
	public static boolean save(dao.User user) throws PersistentException {
		try {
	...
	public static boolean delete(dao.User user) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.User user)throws PersistentException {
		try {
			...
			dao.Trial[] lTrials = user.trial.toArray();
	...
	public static boolean deleteAndDissociate(dao.User user, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (user.getRole() != null) {
				user.getRole().user.remove(user);
			}
	...
	public static boolean refresh(dao.User user) throws PersistentException {
		try {
	...
	public static boolean evict(dao.User user) throws PersistentException {
		try {
