...
public class NotificationDAO {
	...
	public static boolean save(dao.Notification notification) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Notification notification) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Notification notification)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Notification notification, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (notification.getCompetition() != null) {
				notification.getCompetition().notification.remove(notification);
			}
	...
	public static boolean refresh(dao.Notification notification) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Notification notification) throws PersistentException {
		try {
