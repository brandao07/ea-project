...
public class RoleDAO {
	...
	public static boolean save(dao.Role role) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Role role) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Role role)throws PersistentException {
		try {
			dao.User[] lUsers = role.user.toArray();
	...
	public static boolean deleteAndDissociate(dao.Role role, org.orm.PersistentSession session)throws PersistentException {
		try {
			dao.User[] lUsers = role.user.toArray();
			for(int i = 0; i < lUsers.length; i++) {
				lUsers[i].setRole(null);
	...
	public static boolean refresh(dao.Role role) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Role role) throws PersistentException {
		try {
