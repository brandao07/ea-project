...
public class ResultDAO {
	...
	public static boolean save(dao.Result result) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Result result) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Result result)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Result result, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (result.getTrial() != null) {
				result.getTrial().result.remove(result);
			}
	...
	public static boolean refresh(dao.Result result) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Result result) throws PersistentException {
		try {
