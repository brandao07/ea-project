...
public class GradeDAO {
	...
	public static boolean save(dao.Grade grade) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Grade grade) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Grade grade)throws PersistentException {
		try {
			dao.Trial[] lTrials = grade.trial.toArray();
	...
	public static boolean deleteAndDissociate(dao.Grade grade, org.orm.PersistentSession session)throws PersistentException {
		try {
			dao.Trial[] lTrials = grade.trial.toArray();
			for(int i = 0; i < lTrials.length; i++) {
				lTrials[i].setGrade(null);
	...
	public static boolean refresh(dao.Grade grade) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Grade grade) throws PersistentException {
		try {
