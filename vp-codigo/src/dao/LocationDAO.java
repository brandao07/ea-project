...
public class LocationDAO {
	...
	public static boolean save(dao.Location location) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Location location) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Location location)throws PersistentException {
		try {
			dao.Trial[] lTrials = location.trial.toArray();
	...
	public static boolean deleteAndDissociate(dao.Location location, org.orm.PersistentSession session)throws PersistentException {
		try {
			dao.Trial[] lTrials = location.trial.toArray();
			for(int i = 0; i < lTrials.length; i++) {
				lTrials[i].setLocation(null);
	...
	public static boolean refresh(dao.Location location) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Location location) throws PersistentException {
		try {
