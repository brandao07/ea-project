...
public class CompetitionDAO {
	...
	public static boolean save(dao.Competition competition) throws PersistentException {
		try {
	...
	public static boolean delete(dao.Competition competition) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(dao.Competition competition)throws PersistentException {
		try {
			dao.Trial[] lTrials = competition.trial.toArray();
			for(int i = 0; i < lTrials.length; i++) {
				lTrials[i].setCompetition(null);
			}
			dao.Notification[] lNotifications = competition.notification.toArray();
	...
	public static boolean deleteAndDissociate(dao.Competition competition, org.orm.PersistentSession session)throws PersistentException {
		try {
			dao.Trial[] lTrials = competition.trial.toArray();
			for(int i = 0; i < lTrials.length; i++) {
				lTrials[i].setCompetition(null);
	...
	public static boolean refresh(dao.Competition competition) throws PersistentException {
		try {
	...
	public static boolean evict(dao.Competition competition) throws PersistentException {
		try {
