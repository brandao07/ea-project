...
public class userDAO {
	...
	public static boolean save(eaproject.dao.user luser) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().saveObject(luser);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.user luser) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().deleteObject(luser);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.user luser) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().refresh(luser);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.user luser) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().evict(luser);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
