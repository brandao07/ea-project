...
public class stateDAO {
	...
	public static boolean save(eaproject.dao.state lstate) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().saveObject(lstate);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.state lstate) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().deleteObject(lstate);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.state lstate) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().refresh(lstate);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.state lstate) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().evict(lstate);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
