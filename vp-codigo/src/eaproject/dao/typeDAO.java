...
public class typeDAO {
	...
	public static boolean save(eaproject.dao.type ltype) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().saveObject(ltype);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.type ltype) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().deleteObject(ltype);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.type ltype) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().refresh(ltype);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.type ltype) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().evict(ltype);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
