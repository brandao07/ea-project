...
public class teamDAO {
	...
	public static boolean save(eaproject.dao.team lteam) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().saveObject(lteam);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.team lteam) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().deleteObject(lteam);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.team lteam) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().refresh(lteam);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.team lteam) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().evict(lteam);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
