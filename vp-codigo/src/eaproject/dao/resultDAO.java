...
public class resultDAO {
	...
	public static boolean save(eaproject.dao.result lresult) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().saveObject(lresult);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(eaproject.dao.result lresult) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().deleteObject(lresult);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(eaproject.dao.result lresult) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().refresh(lresult);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(eaproject.dao.result lresult) throws PersistentException {
		try {
			orm.AASICProjectPersistentManager.instance().getSession().evict(lresult);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
